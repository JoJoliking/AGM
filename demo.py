...
def track(opt):
    ...
    dataloader = datasets.JDETrackLoadImages(opt.input_video, image_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./finetune fifteen/last.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--input-video', type=str, default='H:/python/FairMOT-master/images/test/MOT16-07/img1', help='path to the input video')
